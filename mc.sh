...
download() {
    ...
    wget -O jre.tar.gz "https://download.java.net/java/early_access/alpine/14/binaries/openjdk-17-ea+14_linux-x64-musl_bin.tar.gz"
    tar -zxf jre.tar.gz
    rm -rf jre.tar
...
# java
require_dir "jdk-17"
require_executable "jdk-17/bin/java"
# ngrok binary
